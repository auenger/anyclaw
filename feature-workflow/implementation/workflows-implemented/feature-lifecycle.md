...
```
/feature-lifecycle              # Start interactive workflow
/feature-lifecycle --next       # Skip to next stage
/feature-lifecycle --status     # View current status
/feature-lifecycle --restart    # Restart current stage
/feature-lifecycle --abort      # Abort workflow
```
