...
# Run tests with trace and screenshots
npx playwright test --trace on --screenshot on

# Results will be saved to:
# - features/active-{id}/evidence/playwright-report/ (HTML report)
# - features/active-{id}/evidence/test-results.json (JSON results)
# - test-results/*/trace.zip (Trace files - need to copy)
```
